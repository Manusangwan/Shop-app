    ...
    <aside className="filters">
      ...
      <div className="filter-group">
        ...
        <select className="sort-select" value={sortBy} onChange={e => onSortChange(e.target.value)}>
          ...
          <option value="price-asc">Price: Low to High</option>{/* interchanged the values of price-asc and price-desc to correctly reflect their labels in the sorting options */}
